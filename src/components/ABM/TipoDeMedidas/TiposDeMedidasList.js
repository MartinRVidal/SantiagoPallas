        ...
        <TableContainer className="container-abm" >
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={tiposDeMedidasInfo?.result?.length}
            />
            <TableBody>
              {stableSort(tiposDeMedidasInfo.result, getComparator(order, orderBy))
          ...
          <TablePagination
            ...
            colSpan={3}
            count={tiposDeMedidasInfo?.result?.length}
